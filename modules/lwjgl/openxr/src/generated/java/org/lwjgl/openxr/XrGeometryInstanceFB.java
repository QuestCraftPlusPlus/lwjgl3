...
public class XrGeometryInstanceFB extends DispatchableHandle {
    ...
    /**
     * Creates an {@code XrGeometryInstanceFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrGeometryInstanceFB} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrGeometryInstanceFB(long handle, XrSession session) {

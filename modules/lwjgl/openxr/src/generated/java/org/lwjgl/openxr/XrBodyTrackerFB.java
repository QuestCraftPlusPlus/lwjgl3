...
public class XrBodyTrackerFB extends DispatchableHandle {
    ...
    /**
     * Creates an {@code XrBodyTrackerFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrBodyTrackerFB} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrBodyTrackerFB(long handle, XrSession session) {

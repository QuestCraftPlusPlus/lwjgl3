...
public class XrDevicePcmSampleRateGetInfoFB extends XrDevicePcmSampleRateStateFB {
    ...
    public static XrDevicePcmSampleRateGetInfoFB malloc() {
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, nmemAllocChecked(SIZEOF));
    }
    ...
    public static XrDevicePcmSampleRateGetInfoFB calloc() {
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, nmemCallocChecked(1, SIZEOF));
    }
    ...
    public static XrDevicePcmSampleRateGetInfoFB create() {
        ...
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, memAddress(container), container);
    }
    ...
    public static XrDevicePcmSampleRateGetInfoFB create(long address) {
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, address);
    }

    /** Like {@link #create(long) create}, but returns {@code null} if {@code address} is {@code NULL}. */
    @Nullable
    public static XrDevicePcmSampleRateGetInfoFB createSafe(long address) {
        return address == NULL ? null : wrap(XrDevicePcmSampleRateGetInfoFB.class, address);
    }
    ...
    public static XrDevicePcmSampleRateGetInfoFB malloc(MemoryStack stack) {
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, stack.nmalloc(ALIGNOF, SIZEOF));
    }
    ...
    public static XrDevicePcmSampleRateGetInfoFB calloc(MemoryStack stack) {
        return wrap(XrDevicePcmSampleRateGetInfoFB.class, stack.ncalloc(ALIGNOF, 1, SIZEOF));
    }
    ...
    public static class Buffer extends XrDevicePcmSampleRateStateFB.Buffer {
         ...
         * by {@link XrDevicePcmSampleRateGetInfoFB#SIZEOF}, and its mark will be undefined.
         *

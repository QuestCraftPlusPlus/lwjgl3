...
/** Wraps an {@code XrFoveationProfileFB} handle. */
public class XrFoveationProfileFB extends DispatchableHandle {

    private final XrSession session;

    /**
     * Creates an {@code XrFoveationProfileFB} using the specified native handle and {@code XrSession}.
     *
     * @param handle  the native {@code XrFoveationProfileFB} handle
     * @param session the {@code XrSession} from which {@code handle} was created
     */
    public XrFoveationProfileFB(long handle, XrSession session) {

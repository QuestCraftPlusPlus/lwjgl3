 ...
 * }</code></pre>
 */
public class XrSceneMeshBuffersGetInfoMSFT extends Struct<XrSceneMeshBuffersGetInfoMSFT> implements NativeResource {
    ...
    protected XrSceneMeshBuffersGetInfoMSFT(long address, @Nullable ByteBuffer container) {
        super(address, container);
    }

    @Override
    protected XrSceneMeshBuffersGetInfoMSFT create(long address, @Nullable ByteBuffer container) {
        return new XrSceneMeshBuffersGetInfoMSFT(address, container);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT malloc() {
        return new XrSceneMeshBuffersGetInfoMSFT(nmemAllocChecked(SIZEOF), null);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT calloc() {
        return new XrSceneMeshBuffersGetInfoMSFT(nmemCallocChecked(1, SIZEOF), null);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT create() {
        ...
        return new XrSceneMeshBuffersGetInfoMSFT(memAddress(container), container);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT create(long address) {
        return new XrSceneMeshBuffersGetInfoMSFT(address, null);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT malloc(MemoryStack stack) {
        return new XrSceneMeshBuffersGetInfoMSFT(stack.nmalloc(ALIGNOF, SIZEOF), null);
    }
    ...
    public static XrSceneMeshBuffersGetInfoMSFT calloc(MemoryStack stack) {
        return new XrSceneMeshBuffersGetInfoMSFT(stack.ncalloc(ALIGNOF, 1, SIZEOF), null);
    }
    ...
    public static class Buffer extends StructBuffer<XrSceneMeshBuffersGetInfoMSFT, Buffer> implements NativeResource {
         ...
         * by {@link XrSceneMeshBuffersGetInfoMSFT#SIZEOF}, and its mark will be undefined.</p>
         *

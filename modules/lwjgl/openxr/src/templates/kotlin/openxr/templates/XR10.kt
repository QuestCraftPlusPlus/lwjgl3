    ...
    EnumConstant(
        ...
        <table class="lwjgl">
            ...
            <tbody>
                ...
                <tr><td>#ERROR_ANDROID_THREAD_SETTINGS_ID_INVALID_KHR</td><td>xrSetAndroidApplicationThreadKHR failed as thread id is invalid. (Added by the {@link KHRAndroidThreadSettings XR_KHR_android_thread_settings} extension)</td></tr>
                <tr><td>#ERROR_ANDROID_THREAD_SETTINGS_FAILURE_KHR</td><td>xrSetAndroidApplicationThreadKHR failed setting the thread attributes/priority. (Added by the {@link KHRAndroidThreadSettings XR_KHR_android_thread_settings} extension)</td></tr>
        ...
        <h5>See Also</h5>
        ##XrEventDataSceneCaptureCompleteFB, ##XrEventDataSpaceEraseCompleteFB, ##XrEventDataSpaceListSaveCompleteFB, ##XrEventDataSpaceQueryCompleteFB, ##XrEventDataSpaceSaveCompleteFB, ##XrEventDataSpaceSetStatusCompleteFB, ##XrEventDataSpaceShareCompleteFB, ##XrEventDataSpatialAnchorCreateCompleteFB, #ResultToString()
        """,
...
￿    XrSwapchainImageBaseHeader*                 images);</code></pre>
        ...
        <ul>
            ...
            <li>If {@code imageCapacityInput} is not 0, {@code images} <b>must</b> be a pointer to an array of {@code imageCapacityInput} ##XrSwapchainImageBaseHeader-based structures. See also: ##XrSwapchainImageD3D11KHR, ##XrSwapchainImageD3D12KHR, ##XrSwapchainImageOpenGLESKHR, ##XrSwapchainImageOpenGLKHR, ##XrSwapchainImageVulkanKHR</li>
        </ul>
